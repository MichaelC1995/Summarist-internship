                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-20">
                        ...
                        <div className="hidden md:flex items-center space-x-8">
                            ...
                            <Link href="#"
                                  className="text-gray-700 hover:text-gray-900 cursor-not-allowed">Contact</Link>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            <div className="space-y-4 flex-col">
                                <h3 className="text-3xl font-semibold text-left text-gray-700 stats-text-0">Enhance your
                                    knowledge</h3>
                                <h3 className="text-3xl font-semibold text-left text-gray-700 stats-text-1">Achieve
                                    greater success</h3>
                                <h3 className="text-3xl font-semibold text-left text-gray-700 stats-text-2">Improve your
                                    health</h3>
                                <h3 className="text-3xl font-semibold text-left text-gray-700 stats-text-3">Develop
                                    better parenting skills</h3>
                                <h3 className="text-3xl font-semibold text-left text-gray-700 stats-text-4">Increase
                                    happiness</h3>
                                <h3 className="text-3xl font-semibold text-left text-gray-700 stats-text-5">Be the best
                        ...
                        <div className="flex flex-col justify-center">
                            <div
                                className="bg-[#f1f6f4] gap-y-4 p-4 sm:p-5 md:p-8 lg:p-10 rounded-xl shadow-sm space-y-3 sm:space-y-4 min-h-[300px] sm:min-h-[320px] md:min-h-[350px] flex flex-col justify-center">
                                <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
                                    <div
                                        className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-blue-500 flex-shrink-0">93%
                                    </div>
                                ...
                                <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
                                    <div
                                        className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-blue-500 flex-shrink-0">96%
                                    </div>
                                    <p className="text-gray-700 text-xs sm:text-sm md:text-base lg:text-lg break-words">
                                ...
                                <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
                                    <div
                                        className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-blue-500 flex-shrink-0">90%
                                    </div>
                                    <p className="text-gray-700 text-xs sm:text-sm md:text-base lg:text-lg break-words">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 mt-12 items-center">
                        <div className="flex flex-col justify-center order-1 md:order-2">
                            <div
                                className="bg-[#f1f6f4] p-4 sm:p-5 md:p-8 lg:p-10 rounded-xl shadow-sm space-y-3 sm:space-y-4 min-h-[300px] sm:min-h-[320px] md:min-h-[350px] flex flex-col justify-center">
                                <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
                                    <div
                                        className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-blue-500 flex-shrink-0">91%
                                    </div>
                                    <p className="text-gray-700 text-xs sm:text-sm md:text-base lg:text-lg break-words">
                                ...
                                <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
                                    <div
                                        className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-blue-500 flex-shrink-0">94%
                                    </div>
                                    <p className="text-gray-700 text-xs sm:text-sm md:text-base lg:text-lg break-words">
                                ...
                                <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
                                    <div
                                        className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-blue-500 flex-shrink-0">88%
                                    </div>
                                    <p className="text-gray-700 text-xs sm:text-sm md:text-base lg:text-lg break-words">
                        ...
                        <div className="order-1 md:order-2 top-0 right-0">
                            <div className="space-y-6 flex-col items-center justify-center">
                                <h3 className="text-3xl font-semibold text-right text-gray-700 stats-text-0">Expand your
                                    learning</h3>
                                <h3 className="text-3xl font-semibold text-right text-gray-700 stats-text-1">Accomplish
                                    your goals</h3>
                                <h3 className="text-3xl font-semibold text-right text-gray-700 stats-text-2">Strengthen
                                    your vitality</h3>
                                <h3 className="text-3xl font-semibold text-right text-gray-700 stats-text-3">Become a
                                    better caregiver</h3>
                                <h3 className="text-3xl font-semibold text-right text-gray-700 stats-text-4">Improve
                                    your mood</h3>
                                <h3 className="text-3xl font-semibold text-right text-gray-700 stats-text-5">Maximize
                                    your abilities</h3>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
                        <div className="text-center bg-blue-100 rounded-2xl p-8">
                            ...
                            <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-1 sm:mb-2">3
                                Million</h3>
                        ...
                        <div className="text-center bg-blue-100 rounded-2xl p-8">
                            ...
                            <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-1 sm:mb-2">4.5
                                Stars</h3>
                            <p className="text-gray-600 text-sm sm:text-base md:text-lg break-words">
                    ...
                    <div className="grid md:grid-cols-4 gap-8 mb-8">
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li><Link href="#" className="hover:text-white cursor-not-allowed">Summarist
                                    Magazine</Link></li>
                                <li><Link href="#" className="hover:text-white cursor-not-allowed">Cancel
                                    Subscription</Link></li>
                                <li><Link href="#" className="hover:text-white cursor-not-allowed">Help</Link></li>
                                <li><Link href="#" className="hover:text-white cursor-not-allowed">Contact us</Link>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><Link href="#" className="hover:text-white cursor-not-allowed">Summarist
                                    Business</Link></li>
                                <li><Link href="#" className="hover:text-white cursor-not-allowed">Gift Cards</Link>
                                </li>
                                <li><Link href="#" className="hover:text-white cursor-not-allowed">Authors &
                                    Publishers</Link></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><Link href="#" className="hover:text-white cursor-not-allowed">Code of
                                    Conduct</Link></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><Link href="#" className="hover:text-white cursor-not-allowed">Legal Notice</Link>
                                </li>
                                <li><Link href="#" className="hover:text-white cursor-not-allowed">Terms of
                                    Service</Link></li>
                                <li><Link href="#" className="hover:text-white cursor-not-allowed">Privacy
                                    Policies</Link></li>
                            </ul>
                        </div>
                    </div>
